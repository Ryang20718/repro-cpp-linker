...
register_toolchains("//rules/toolchain/gcc_host_compiler:cc_toolchain_k8")
...
# Must use a recent version of curl that supports rustls version 0.12
http_archive(
    name = "curl",
...
http_archive(
    ...
    sha256 = "ff5396f0509f6466521d9c16d5ac6dc86dc48996a3ba8083e2971918fe6a8619",
    strip_prefix = "libpcap",
    urls = ["https://waabi-public-packages.s3.amazonaws.com/third_party/libpcap.tar.gz"],
)
